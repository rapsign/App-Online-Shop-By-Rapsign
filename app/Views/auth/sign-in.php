...
<!-- Mirrored from new.axilthemes.com/demo/template/etrade/sign-in.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 10 Aug 2023 07:18:54 GMT -->

<head>
    <meta charset="utf-8">
    <meta http-equiv="x-ua-compatible" content="ie=edge">
    <title>Gaming Store | Sign In</title>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-sm-8">
                    <div class="singin-header-btn">
                        <p>Not a member?</p>
                        <a href="<?= url_to('register') ?>" class="axil-btn btn-bg-secondary sign-up-btn">Sign Up Now</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-xl-4 col-lg-6">
                <div class="axil-signin-banner bg_image bg_image--9">
                    <h3 class="title">Temukan Barang Yang Kamu Inginkan di GAMING STORE</h3>
                </div>
            </div>
            <div class="col-lg-6 offset-xl-2">
                <div class="axil-signin-form-wrap">
                    <div class="axil-signin-form">
                        <h3 class="title">Sign in to become a member</h3>
                        <p class="b2 mb--55">Enter your detail below</p>
                        <p class="b2 mb--55"><?= view('Myth\Auth\Views\_message_block') ?></p>
                        <form class="singin-form" action="<?= url_to('login') ?>" method="post">
                            <?= csrf_field() ?>
                            ...
                            <div class="form-group align-items-center d-grid gap-2">
                                <button type="submit" class="axil-btn btn-bg-primary btn-lg btn-block">Sign In</button>
                        </form>
                        <a class="axil-btn btn-bg-white btn-lg btn-block text-center btn btn-outline-secondary" href="<?= base_url('auth/google') ?>"><img src="https://img.icons8.com/color/16/000000/google-logo.png"> Sign In Using Google</a>
                    </div>
