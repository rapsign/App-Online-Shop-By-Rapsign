            ...
            <div class="col-lg-6 offset-xl-2">
                <div class="axil-signin-form-wrap">
                    <div class="axil-signin-form">
                        ...
                        <p class="b2 mb--55">Enter your new password below</p>
                        <p class="b2 mb--55"><?= view('Myth\Auth\Views\_message_block') ?></p>
                        <form class="singin-form" action="<?= base_url('set-password') ?>" method="post">
                            <?= csrf_field() ?>

                            <div class="form-group">
                                <label>New Password</label>
                                <input type="password" class="form-control" placeholder="New Password" autocomplete="off" name="password" require>
                            </div>
